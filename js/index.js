...
const expandSeedsBtn = document.querySelector('.seeds__text-expand-button');
...
expandSeedsBtn.addEventListener('click', () => {
    ...
    expandSeedsText.classList.toggle('seeds__text--expanded');
    expandSeedsBtn.classList.toggle('seeds__text-expand-button--expanded');
});
